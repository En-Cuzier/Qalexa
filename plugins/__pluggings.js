...
Asena.addCommand({pattern: 'tenuz ?(.*)', fromMe: true, desc: Lang.INSTALL_DESC, warn: Lang.WARN}, (async (message, match) => {
...
Asena.addCommand({pattern: 'tenuhx(?: |$)(.*)', fromMe: true, desc: Lang.REMOVE_DESC}, (async (message, match) => {
